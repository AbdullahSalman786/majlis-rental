...
import mainHookah from "@/assets/images/home/main-hookah.webp";
import luxuryWedding from "@/assets/images/home/luxury-weddings.webp";
import corporateEvent from "@/assets/images/home/corporate-events.webp";
import yachtExperience from "@/assets/images/home/yacht-experiences.webp";
import privateCelebrations from "@/assets/images/home/private-celebrations.webp";
import cta from "@/assets/images/home/cta.webp";
...
const services = [
  {
    ...
    desc: "Curated hookah experiences that complement your celebration.",
    img: IMG.wedding,
  },
  {
    title: "Corporate Events",
    desc: "Sophisticated hospitality that impresses clients.",
    img: IMG.corporate,
  },
  {
    title: "Yacht Experiences",
    desc: "Premium on-water service for private charters.",
    img: IMG.yacht,
  },
  {
    title: "Private Celebrations",
    desc: "Bespoke experiences for intimate gatherings.",
    img: IMG.party,
  },
];
...
const reviews = [
  {
    ...
    role: "Wedding · Miami",
    text: "Every detail was handled with the care you'd expect from a five-star hotel. Our guests couldn't stop talking about it.",
    initials: "IM",
  },
  {
    name: "Marcus Johnson",
    role: "Corporate Event Planner",
    text: "They transformed our corporate gala into something truly memorable. Professional, elegant, and perfectly executed.",
    initials: "MJ",
  },
  {
    name: "Sofia Rodriguez",
    role: "Birthday · Miami Beach",
    text: "From setup to service, everything was flawless. The VIP package was worth every penny.",
    initials: "SR",
  },
  {
    name: "David Chen",
    role: "Yacht Charter",
    text: "Having premium hookah service on our charter was the perfect touch. They truly understand maritime luxury.",
    initials: "DC",
  },
  {
    name: "Natasha Williams",
    role: "Hotel Coordinator",
    text: "We partner with Hookah Rental for resort events. The consistency they bring matches our five-star property.",
    initials: "NW",
  },
  {
    name: "Roberto Fernandez",
    role: "Private Party Host",
    text: "Premium equipment, unlimited flavors, most professional staff. They turned our party into a VIP lounge.",
    initials: "RF",
  },
  {
    name: "Alexandra Kim",
    role: "Wedding Planner",
    text: "As a luxury planner, I need vendors I can trust completely. Hookah Rental never disappoints.",
    initials: "AK",
  },
  {
    name: "James Patterson",
    role: "Corporate · Brickell",
    text: "The setup was stunning and service seamless. Multiple attendees asked for their contact.",
    initials: "JP",
  },
  {
    name: "Camila Vasquez",
    role: "Anniversary Celebration",
    text: "Our anniversary was elevated beyond what we imagined. Exceptional from start to finish.",
    initials: "CV",
  },
];
...
function TestimonialCarousel() {
  ...
  while (visibleReviews.length < cardsPerView)
          ...
          {Array.from({ length: totalPages }).map((_, i) => (
            <button
              ...
              style={{
                ...
                height: "7px",
                background:
                  i === currentPage ? "var(--gold)" : "rgba(255,255,255,0.15)",
                cursor: "pointer",
                border: "none",
              }}
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to bottom, rgba(8,8,8,0.35) 0%, rgba(8,8,8,0.6) 55%, rgba(8,8,8,0.95) 100%)",
            }}
          />
        </div>
        ...
        >
          <div style={{ maxWidth: "700px" }}>
            ...
            <p
              className="lux-body"
              style={{ marginBottom: "40px", maxWidth: "580px" }}
            >
              A luxury catering company delivering refined hookah experiences
              for weddings, corporate events, yacht parties, and private
              celebrations.
            </p>
        ...
        <div className="site-container">
          ...
          >
            ...
            <div>
              ...
              >
                We are a luxury catering company that has elevated the hookah
                experience into a refined, premium hospitality offering. Every
                element reflects the attention to detail found in the world's
                finest hotels.
              </p>
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      padding: "16px 18px",
                      transition:
                        "background 250ms ease, border-color 250ms ease, transform 250ms ease",
                    }}
                    onMouseEnter={(e) => {
          ...
          >
            {testimonialStats.map((s, idx) => (
              <div
                ...
                style={{
                  borderRight:
                    idx < testimonialStats.length - 1
                      ? "1px solid rgba(255,255,255,0.06)"
                      : "none",
                }}
              >
                <p className="stat-number">{s.v}</p>
                <p className="stat-label" style={{ marginTop: "10px" }}>
                  {s.l}
                </p>
              </div>
            ))}
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(8,8,8,1) 0%, rgba(8,8,8,0.85) 50%, rgba(18,14,5,0.7) 100%)",
            }}
          />
        </div>
        ...
        >
          ...
          >
            Premium dates are limited. Contact our concierge team to reserve
            your experience.
          </p>
