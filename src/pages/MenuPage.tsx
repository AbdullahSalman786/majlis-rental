...
const brands = [
  {
    ...
    refillPrice: null,
    note: 'Available $50',
    img: 'https://images.pexels.com/photos/3622608/pexels-photo-3622608.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=400&w=600',
    categories: [
      {
        name: 'Minty',
        img: 'https://images.pexels.com/photos/2995309/pexels-photo-2995309.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=300&w=400',
        flavors: ['Citrus Mint', 'Grape Mint', 'Gum Mint', 'Lemon Mint', 'Orange Mint', 'Peach Mint', 'Two Apples Mint', 'Watermelon Mint'],
      },
      {
        name: 'Creamy',
        img: 'https://images.pexels.com/photos/1332267/pexels-photo-1332267.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=300&w=400',
        flavors: ['Mint Cream', 'Orange Cream', 'Strawberry Cream'],
      },
      {
        name: 'Aromatic',
        img: 'https://images.pexels.com/photos/931177/pexels-photo-931177.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=300&w=400',
        flavors: ['Bubble Gum', 'Rose', 'Vanilla'],
      },
      {
        name: 'Fruity',
        img: 'https://images.pexels.com/photos/1132047/pexels-photo-1132047.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=300&w=400',
        flavors: ['Berry', 'Blueberry', 'Grapefruit', 'Grenadine', 'Lemon', 'Orange', 'Peach', 'Strawberry'],
      },
      {
        name: 'Tropical',
        img: 'https://images.pexels.com/photos/1132047/pexels-photo-1132047.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=300&w=400',
        flavors: ['Coconut', 'Guava', 'Kiwi', 'Mango', 'Pineapple', 'Watermelon'],
      },
    ],
  },
  {
    ...
    refillPrice: '$10',
    note: null,
    img: 'https://images.pexels.com/photos/3727255/pexels-photo-3727255.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=400&w=600',
    categories: [
      {
        name: 'Signature Blends',
        img: 'https://images.pexels.com/photos/3622608/pexels-photo-3622608.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=300&w=400',
        flavors: ['Angel Lips', 'Baku Nights', 'Berlin Nights', 'Havana', 'Hawaii', 'Lady Killer', 'Love 66', 'Strawberry Splash'],
      },
    ],
  },
  {
    ...
    refillPrice: '$10',
    note: null,
    img: 'https://images.pexels.com/photos/3994839/pexels-photo-3994839.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=400&w=600',
    categories: [
      {
        name: 'Lit Series',
        img: 'https://images.pexels.com/photos/2995309/pexels-photo-2995309.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=300&w=400',
        flavors: ['Blueberry Lit', 'Lemon Lit', 'Lime Lit', 'Peach Lit', 'Watermelon Lit'],
      },
    ],
  },
  {
    ...
    categories: [
      {
        ...
        img: 'https://images.pexels.com/photos/3994839/pexels-photo-3994839.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=300&w=400',
        flavors: ['Chief Commissioner', 'Lychee', 'Paan Raas'],
      },
      {
        name: 'Paan Mix',
        img: 'https://images.pexels.com/photos/1132047/pexels-photo-1132047.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=300&w=400',
        flavors: ['Paan Orange Mint', 'Paan Blueberry', 'Paan Double Apple', 'Paan Vanilla Mint', 'Paan Kiwi', 'Lychee Paan'],
      },
    ],
  },
];
    ...
    <AnimateWrap>
        ...
        <div className="site-container text-center relative z-10">
          ...
          <FadeIn delay={0.2}>
            <p className="mt-space-6 text-text-secondary text-body font-light max-w-2xl mx-auto leading-[1.5]">
              Premium hookah brands with unlimited flavors. Customize your bowl, base, and hose for a truly personal experience.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="bg-alt border-t border-white/[0.06]" style={{ paddingTop: 'var(--sp-8)', paddingBottom: 'var(--sp-8)' }}>
        <div className="site-container">
          ...
          />
          <StaggerContainer staggerDelay={0.08} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-space-6">
            {bowlOptions.map(opt => (
              <StaggerItem key={opt.label}>
                <motion.div
                  className="site-card flex items-start gap-space-4"
                  whileHover={{ scale: 1.01, borderColor: 'rgba(198,161,69,0.2)' }}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-space-3">
                      <p className="text-small-text font-semibold text-text-primary">{opt.label}</p>
                      {opt.price && (
                        <span className="text-primary font-bold text-small-text flex-shrink-0">{opt.price}</span>
                      )}
                    </div>
                    <p className="text-xs text-text-muted mt-space-1 font-light">{opt.note}</p>
                  </div>
                </motion.div>
              </StaggerItem>
            ))}
          ...
          <ScaleIn delay={0.4}>
            ...
            >
              <p className="text-primary font-semibold text-small-text">🧊 Both at Discount Price</p>
              <p className="font-display text-section-heading font-light text-primary mt-space-2">
                <Counter value="5" prefix="$" />
              </p>
              <p className="text-xs text-text-muted mt-space-2">Ice Base & Hose — Majlis Special</p>
            </div>
          </ScaleIn>
        </div>
      </section>
                    ...
                    {(selected.hookahPrice || selected.note) && (
                      <div className="flex flex-wrap gap-space-3 mt-space-2">
                        {selected.hookahPrice && (
                          ...
                          >
                            <p className="text-xs text-text-muted font-light">Hookah</p>
                            <p className="font-display text-card-title font-semibold text-primary">{selected.hookahPrice}</p>
                          </motion.div>
                        )}
                        {selected.refillPrice && (
                          <div className="bg-surface border border-border rounded-[var(--radius-md)] px-space-5 py-space-3 text-center">
                            <p className="text-xs text-text-muted font-light">Refill</p>
                            <p className="font-display text-card-title font-semibold text-text-primary">{selected.refillPrice}</p>
                          </div>
                        )}
                        {selected.note && (
                          <div className="bg-primary-muted border border-primary/20 rounded-[var(--radius-md)] px-space-5 py-space-3 text-center">
                            <p className="font-semibold text-primary text-small-text">{selected.note}</p>
                          </div>
                        )}
                      </div>
                    )}
              ...
              <div className="space-y-space-8">
                {selected.categories.map((cat, ci) => (
                  <motion.div
                    ...
                    transition={{ delay: ci * 0.1, type: 'spring', stiffness: 180, damping: 22 }}
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-[180px_1fr] lg:grid-cols-[220px_1fr]">
                      ...
                      <div className="p-space-7">
                        ...
                        <StaggerContainer staggerDelay={0.04} className="flex flex-wrap gap-space-2">
      ...
      {/* ── Disclaimer ── */}
      <section className="bg-alt border-t border-white/[0.06]" style={{ paddingTop: 'var(--sp-6)', paddingBottom: 'var(--sp-6)' }}>
        <div className="site-container text-center max-w-2xl mx-auto">
          <FadeIn>
            <p className="text-xs text-text-muted font-light leading-[1.8]">
              Maximum of 2 people per hookah, or $10 additional per person.
              18% Automatic Gratuity will be added to the Final Bill.
              All prices are subject to change. Menu availability may vary.
            </p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="relative z-10 site-container text-center">
          ...
          <FadeIn delay={0.15}>
            <p className="text-text-secondary text-body font-light max-w-lg mx-auto leading-[1.6] mb-space-8">
              Reserve your premium hookah experience with unlimited flavors from our entire menu collection.
            </p>
          </FadeIn>
          <FadeIn delay={0.3}>
