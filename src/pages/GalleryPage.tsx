...
const images = [
  {
    src: "https://images.pexels.com/photos/17315409/pexels-photo-17315409.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    cat: "Wedding",
    alt: "Luxury wedding reception",
  },
  {
    src: "https://images.pexels.com/photos/20122617/pexels-photo-20122617.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
    cat: "Hookah",
    alt: "Premium gold hookah",
  },
  {
    src: "https://images.pexels.com/photos/16935900/pexels-photo-16935900.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    cat: "Corporate",
    alt: "Luxury lounge",
  },
  {
    src: "https://images.pexels.com/photos/29318858/pexels-photo-29318858.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    cat: "Yacht",
    alt: "Yacht sunset",
  },
  {
    src: "https://images.pexels.com/photos/17315439/pexels-photo-17315439.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    cat: "Wedding",
    alt: "Elegant decor",
  },
  {
    src: "https://images.pexels.com/photos/14443340/pexels-photo-14443340.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
    cat: "Hookah",
    alt: "Hookah closeup",
  },
  {
    src: "https://images.pexels.com/photos/16935974/pexels-photo-16935974.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    cat: "VIP",
    alt: "VIP lounge",
  },
  {
    src: "https://images.pexels.com/photos/19986452/pexels-photo-19986452.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    cat: "Event",
    alt: "Restaurant event",
  },
  {
    src: "https://images.pexels.com/photos/17315476/pexels-photo-17315476.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    cat: "Wedding",
    alt: "Decorated venue",
  },
  {
    src: "https://images.pexels.com/photos/16935993/pexels-photo-16935993.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    cat: "VIP",
    alt: "Premium lounge",
  },
  {
    src: "https://images.pexels.com/photos/29318864/pexels-photo-29318864.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    cat: "Yacht",
    alt: "Yachts sunset",
  },
  {
    src: "https://images.pexels.com/photos/14036272/pexels-photo-14036272.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
    cat: "Hotel",
    alt: "Hotel lobby",
  },
];
    ...
    <AnimateWrap>
      ...
      >
        <div className="site-container text-center">
          <FadeIn delay={0}>
            <span className="text-primary text-small-text font-semibold tracking-[0.15em] uppercase mb-space-4 block">
              Gallery
            </span>
          </FadeIn>
          <FadeIn delay={0.1}>
      ...
      >
        <div className="site-container">
          ...
          <FadeIn delay={0.1}>
            <div
              className="flex flex-wrap justify-center gap-space-2 mb-space-9"
              role="tablist"
            >
              {cats.map((c) => (
                <motion.button
        ...
        {lb !== null && (
          ...
          >
            ...
            <motion.button
              onClick={(e) => {
                e.stopPropagation();
                setLb((lb - 1 + images.length) % images.length);
              }}
            ...
            >
              <p className="text-text-primary text-small-text font-medium">
                {images[lb].alt}
              </p>
